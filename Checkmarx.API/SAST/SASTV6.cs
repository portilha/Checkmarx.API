...
namespace Checkmarx.API.SASTV6
{
    ...
    public partial class SASTV6Client
    {
        ...
        public virtual System.Threading.Tasks.Task<ResultsStatisticsDto2> GetResultsStatisticsByidAsync(long id)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ResultsStatisticsDto2> GetResultsStatisticsByidAsync(long id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    request_.Headers.Accept.Add(System.Net.Http.Headers.MediaTypeWithQualityHeaderValue.Parse("application/json;v=6.0"));

                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "sast/scans/{id}/resultsStatistics"
                    urlBuilder_.Append("sast/scans/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/resultsStatistics");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ResultsStatisticsDto2>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ScanCompareSummaryDto2> GetScanCompareSummaryByoldScanIdnewScanIdAsync(long oldScanId, long newScanId)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ScanCompareSummaryDto2> GetScanCompareSummaryByoldScanIdnewScanIdAsync(long oldScanId, long newScanId, System.Threading.CancellationToken cancellationToken)
        {
            if (oldScanId == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ScanCompareSummaryDto2>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <param name="oldScanId">Old scan id</param>
        /// <param name="newScanId">New scan id</param>
        /// <param name="includeQueriesData">will include the query categories information, default value is "false"</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ExtendedScanCompareResultsDtoV6> GetCompareScanResultsByoldScanIdnewScanIdIncludeQueriesDataAsync(long oldScanId, long newScanId, bool? includeQueriesData)
        {
            return GetCompareScanResultsByoldScanIdnewScanIdIncludeQueriesDataAsync(oldScanId, newScanId, includeQueriesData, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ExtendedScanCompareResultsDtoV6> GetCompareScanResultsByoldScanIdnewScanIdIncludeQueriesDataAsync(long oldScanId, long newScanId, bool? includeQueriesData, System.Threading.CancellationToken cancellationToken)
        {
            if (oldScanId == null)
                throw new System.ArgumentNullException("oldScanId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(newScanId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('?');
                    if (includeQueriesData != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("IncludeQueriesData")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(includeQueriesData, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    }
                    urlBuilder_.Length--;
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ExtendedScanCompareResultsDtoV6>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    public partial class ResultsStatisticsDto2
    {
        [Newtonsoft.Json.JsonProperty("criticalSeverity", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public long? CriticalSeverity { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ScanCompareSummaryDto2
    {
        ...
        public ScanCompareCountDto Critical { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ExtendedScanCompareResultsDtoV6
    {
        [Newtonsoft.Json.JsonProperty("results", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<ExtendedScanCompareResultDataDtoV6> Results { get; set; }

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ExtendedScanCompareResultDataDtoV6
    {
        ...
        [Newtonsoft.Json.JsonProperty("cweId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("categoriesCollection", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<CategoryEntity> CategoriesCollection { get; set; }
    ...
    public partial class CategoryEntity
    {
        ...
        [Newtonsoft.Json.JsonProperty("categoryTypeName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
