...
namespace Checkmarx.API.SCA
{
    ...
    public partial class Client
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<string> GetScanReportAsync(System.Guid scanId)
        {
            return GetScanReportAsync(scanId, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<string> GetScanReportAsync(System.Guid scanId, System.Threading.CancellationToken cancellationToken, string format = "pdf", string dataType = "dataType[]=all")
        {
